...
<div style="color:#FFF; text-align: center; padding:11% 0;">
<i class="layui-icon" style="line-height:20rem; font-size:20rem; color: #ddd;">&#xe61c;</i>
<p style="font-size: 20px; font-weight: 300; color: #ddd;">我勒个去，资源被歪星人收走了!</p>
</div>
  </div>
</div>
