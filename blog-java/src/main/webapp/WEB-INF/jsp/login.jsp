...
<form class="layui-form layui-form-pane" style="margin-top:25px;" id="form" method="post">
  <div class="layui-form-item" pane> 
    ...
    <div class="layui-input-block">
      <input type="text" name="userid" id="userid" required  placeholder="请输入手机号" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item" pane>
	...
	<div class="layui-form-item" pane> 
     ...
     <a href="#" onclick="getpwd();" style="position: absolute;left:0px;color: #fff;">找回密码</a>
   </div>
</div>

<!-- 找回密码块 -->
<div class="layui-main" style="width:500px; margin-top:10%;text-align:center;display: none;" id="getpwd">
	<img  src="image/logoa.png">
	<form class="layui-form layui-form-pane" style="margin-top:25px;" id="form1" method="post"> 
	  <div class="layui-form-item" pane>
	  ...
	  <div class="layui-form-item" pane>
	    <label class="layui-form-label"><i class="layui-icon layui-icon-password">密码</i></label>
	    <div class="layui-input-block">
	      <input type="password" name="backpassword" id="backpassword" required  placeholder="请输入密码" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	</form>
	<div class="layui-form-item" pane> 
     <button class="layui-btn layui-btn-fluid" id="backpwd">重设密码</button>
     <a href="#" onclick="cancel();" style="position: absolute;right:0px;color: #fff;">返回登录</a>
   </div>
</div>
